...
#define SIMPLE_TX_LOG_TAG "TAG SIMPLE TX"
#define SIMPLE_TX_LOG_LEVEL ESP_LOG_INFO
...
void tag_simple_tx_main(void) {

    esp_log_level_set(SIMPLE_TX_LOG_TAG, SIMPLE_TX_LOG_LEVEL);
    ...
    {
        ESP_LOGE(SIMPLE_TX_LOG_TAG, "IDLE FAILED");
        while (100);
    }
    ...
    {
        ESP_LOGE(SIMPLE_TX_LOG_TAG, "INIT FAILED");
        while (100);
    }
    ...
    {
        ESP_LOGE(SIMPLE_TX_LOG_TAG, "CONFIG FAILED");
        while (100);
    }
    ...
    while(1) {
        ...
        {
            ESP_LOGI(SIMPLE_TX_LOG_TAG, "WHAT!!!");
        ...
        ESP_LOGI(SIMPLE_TX_LOG_TAG, "TX Frame Sent");
